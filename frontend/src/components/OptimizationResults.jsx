                                                    ...
                                                    {wfWindow.train_results.map((result, idx) => {
                                                        ...
                                                        return (
                                                            <tr key={idx} className="hover:bg-gray-50">
                                                                ...
                                                                <td className="px-2 py-2">{result.stop_loss_pct ? `${result.stop_loss_pct}%` : '-'}</td>
                                            ...
                                            <div className="mt-4 p-4 bg-blue-50 rounded border border-blue-300">
                                                ...
                                                <div className="mb-3 p-3 bg-white rounded shadow-sm">
                                                    ...
                                                    <div className="grid grid-cols-4 gap-2 text-xs">
                                                        ...
                                                        <div>
                                                            <span className="text-gray-600">Stop Loss:</span> <span className="font-medium">{wfWindow.portfolio_state.best_params.stop_loss_pct ? `${wfWindow.portfolio_state.best_params.stop_loss_pct}%` : 'Off'}</span>
                                                        </div>
                                                        <div>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {sortedResults.map((result, index) => (
                                    <tr key={index} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-2 py-2 text-sm">{result.stop_loss_pct ? `${result.stop_loss_pct}%` : '-'}</td>
